...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 27, 2019 at 03:15 PM
...
(28, 'P1001', 'นมรสออริจินัล', 490),
(29, 'P1002', 'นมรสหวาน', 450),
(30, 'P1003', 'นมรสสตรอเบอรี่', 450),
(31, 'P1004', 'นมรสกล้วย', 450),
(32, 'P1005', 'นมรสช็อกโกแลต', 450);
...
(1, '2019-11-26', 'C0001', 'P1004', 'R001', 4, '1'),
(2, '2019-11-27', 'C0001', 'P1003', 'R001', 5, '1'),
(3, '2019-11-20', 'G001', 'A3003', 'R001', 5, '2'),
(4, '2019-11-20', 'G001', 'P1004', 'R001', 5, '2');
...
(1, '2019-11-20', 'G001', 'A3003', 'R001', 5),
(2, '2019-11-20', 'G001', 'P1004', 'R001', 5);
...
(1, '2019-11-26', 'C0001', 'P1004', 'R001', 4),
(2, '2019-11-27', 'C0001', 'P1003', 'R001', 5);
...
--
ALTER TABLE `acd_log_expense`
  MODIFY `log_exp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `acd_log_income`
--
ALTER TABLE `acd_log_income`
  MODIFY `log_ic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
